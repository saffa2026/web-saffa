...
1. "Bubur Halus Beras Putih" [ID: m1] (Kategori: gurih, Untuk Usia: 6-8 Bulan, Harga: Rp 7.000). Bahan umum: Beras Putih Premium Saffa, ditambah protein harian silih berganti (Ayam/Sapi/Ikan/Telur) & sayuran segar. Manfaat: Aman dan pas sebagai menu perkenalan awal MPASI lembut.
2. "Bubur Halus Beras Merah Putih" [ID: m2] (Kategori: gurih, Untuk Usia: 6-8 Bulan, Harga: Rp 7.000). Bahan umum: Beras Merah & Beras Putih Premium Saffa, protein harian bervariasi harian (Ayam/Sapi/Ikan/Telur) & sayuran mikro harian. Manfaat: Memberikan serat optimal untuk melancarkan pencernaan anak.
3. "Nasi Tim" [ID: m3] (Kategori: spesial, Untuk Usia: 8-11 & 12+ Bulan, Harga: Rp 9.000). Bahan umum: Beras Tim Premium Saffa, kombinasi protein cincang (Sapi/Ayam Kampung/Salmon) & sayuran cincang berganti-ganti setiap harinya. Manfaat: Tekstur ideal untuk melatih keterampilan mengunyah bagi bayi 8 bulan ke atas.
...
// Configure Vite integration for development or production builds
async function startServer() {
  if (process.env.NODE_ENV !== "production") {
    ...
    console.log("Joined Vite middleware for React Development.");
  } else {
  ...
  app.listen(PORT, "0.0.0.0", () => {
    console.log(`Saffa Bubur Bayi full-stack server running on http://localhost:${PORT}`);
  });
}
